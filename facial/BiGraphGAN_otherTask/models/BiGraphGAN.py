...
class TransferModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        input_nc = [opt.P_input_nc, opt.P_input_nc+opt.P_input_nc]
        ...
        if self.isTrain:
            ...
            if opt.with_D_PB:
                self.netD_PB = networks.define_D(opt.P_input_nc+opt.P_input_nc, opt.ndf,
    ...
    def set_input(self, input):
        ...
        self.image_paths = input['P1_path']
