...
This repository use the same dataset format as [SelectionGAN](https://github.com/Ha0Tang/SelectionGAN/tree/master/person_transfer#data-preperation) and [XingGAN](https://github.com/Ha0Tang/XingGAN). so you can use the same data for all these methods.
